...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/minuredire/izin/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/minuredire/izin/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/minuredire/izin/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/minuredire/vip/main/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/minuredire/izin/main/ip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/minuredire/izin/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ🐳","url":"https://t.me/dilanjaya"},{"text":"ɪɴꜱᴛᴀʟʟ🐬","url":"https://github.com"}]]}'
